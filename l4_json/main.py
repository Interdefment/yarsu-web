"""
JSON - это текстовй формат данных, основанный на Javascript (Javascript object notation)

Сериализация - преобразование хранящихся в памяти данных в строку
Десериализация - восстановление данных из сериализованной строки
"""

# Примеры использования методов dump, dumps, load, loads
import json
